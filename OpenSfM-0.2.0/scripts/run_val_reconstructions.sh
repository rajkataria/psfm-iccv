...
declare -a uiuctag_datasets=("UIUCTag/ece_floor3_loop_ccw" "UIUCTag/ece_floor3_loop_cw" "UIUCTag/ece_floor5" "UIUCTag/ece_floor5_wall" "UIUCTag/ece_stairs" "UIUCTag/yeh_night_all" "UIUCTag/yeh_night_backward" "UIUCTag/yeh_night_forward")
