...
declare -a eth3d_datasets=("ETH3D/boulders" "ETH3D/courtyard" "ETH3D/living_room" "ETH3D/lecture_room" "ETH3D/exhibition_hall")
declare -a uiuctag_datasets=("UIUCTag/ece_floor5_wall" "UIUCTag/ece_floor3_loop_ccw" "UIUCTag/ece_floor3_loop_cw")
...
declare -a tanksandtemples_datasets=("TanksAndTemples/Ballroom" "TanksAndTemples/Meetingroom")
